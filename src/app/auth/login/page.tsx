        ...
        >
          ...
          <div className="relative bg-card border border-border rounded-2xl p-8 lg:p-12">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-text-secondary text-sm">
                Sign in to your SurakshaSetu account
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-border bg-background checked:bg-primary checked:border-primary focus:ring-2 focus:ring-primary/20"
                  />
                  <span className="text-sm text-text-secondary">Remember me</span>
                </label>
                <Link href="/auth/forgot-password" className="text-sm text-primary hover:text-accent-hover transition-colors">
                  Forgot password?
                </Link>
              </div>
              ...
              <Link
                href="/contact"
                className="w-full bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white font-monospace uppercase py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-[0_10px_40px_rgba(34,197,94,0.3)]"
              >
            ...
            <p className="text-center text-sm text-text-secondary mt-8">
              ...
              <Link href="/auth/signup" className="text-primary hover:text-accent-hover font-semibold transition-colors">
                Create account
              </Link>
            </p>
          </div>
          ...
          >
            <p className="text-xs text-text-muted">
              🔒 Secured by <span className="text-primary">256-bit encryption</span> and <span className="text-primary">multi-factor authentication</span>
            </p>
          </motion.div>
        </motion.div>
      </div>
